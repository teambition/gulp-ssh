...
module.exports = function () {
  ...
  gulp.task('dest', function () {
    return gulp
      ...
      .pipe(gulpSSH.dest('/home/node4/test/ssh2/'))
  })

  gulp.task('sftp-read', function () {
    return gulpSSH.sftp('read', '/home/node4/test/ssh2/package.json', {filePath: 'ssh2-package.json'})
      .pipe(gulp.dest('logs'))
  })

  gulp.task('sftp-write', function () {
    return gulp.src('test/index.js')
      .pipe(gulpSSH.sftp('write', '/home/node4/test/gulp-ssh-test.js'))
  })
